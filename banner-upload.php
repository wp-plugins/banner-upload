...
function buffercode_script_include()
{
wp_enqueue_style('thickbox');
wp_enqueue_script('media-upload');
wp_enqueue_script('thickbox');
wp_enqueue_script( 'script-name', plugins_url( '/js/script.js' , __FILE__ ));
}
add_action('admin_enqueue_scripts', 'buffercode_script_include');
?>